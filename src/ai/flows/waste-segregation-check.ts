...
4.  **Provide a reason:** Briefly explain your decision in the **reason** field. If incorrect, clearly state what was wrong (e.g., "Incorrect. Plastic items found in wet waste." or "Correct. Only dry recyclable materials are visible.").`,
});
